...
SECRET_KEY = 'django-insecure-#t1a!&urh%1z^#qfy0)4hk=d16fepz-c1(jm9f2_vum_2g*y__'
...
SWAGGER_SETTINGS = {
    'DEFAULT_INFO': 'thesis_project.urls.swagger_info',
}
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'swagger_files')
]
